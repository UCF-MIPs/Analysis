...
for edge_type in edge_types:
    ...
    pathway_lengths[edge_type] = path_av

print(pathway_lengths)
names = list(pathway_lengths.keys())
values = list(pathway_lengths.values())

plt.ion()
plt.bar(range(len(pathway_lengths)), values)
plt.xticks(range(len(pathway_lengths)), names, rotation='vertical')
